/ LiquidEther - Vanilla JS version with Three.js
// Fluid simulation background effect
...
class LiquidEther {
    ...
    init() {
        ...
        class MouseClass {
            ...
            init(container, takeoverDuration) {
                this.container = container;
        ...
        // Simulation Classes
        const createSimulationClasses = (shaders) => {
            ...
            return { Advection, ExternalForce, Viscous, Divergence, Poisson, Pressure };
        };

        const SimClasses = createSimulationClasses(shaders);
        ...
        class Simulation {
            ...
            createShaderPass() {
                this.advection = new SimClasses.Advection({
                ...
                this.externalForce = new SimClasses.ExternalForce({
                    cellScale: this.cellScale,
                    cursor_size: this.options.cursor_size,
                    dst: this.fbos.vel_1
                });
                this.viscous = new SimClasses.Viscous({
                    cellScale: this.cellScale,
                ...
                this.divergence = new SimClasses.Divergence({
                    cellScale: this.cellScale,
                    boundarySpace: this.boundarySpace,
                ...
                this.poisson = new SimClasses.Poisson({
                    cellScale: this.cellScale,
                    boundarySpace: this.boundarySpace,
                    src: this.fbos.div,
                ...
                this.pressure = new SimClasses.Pressure({
                    cellScale: this.cellScale,
                    boundarySpace: this.boundarySpace,
        ...
        class WebGLManager {
            constructor(props) {
                ...
                Mouse.init(props.$wrapper, props.takeoverDuration);
